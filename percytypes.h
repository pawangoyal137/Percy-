...
/** @file
This header contains typedefs for seamless switching between 32- and 64-bit 
builds of Percy++.
...
<dl>
<dt>sid_t</dt><dd>server ids</dd>
<dt>dbsize_t</dt><dd>blocks; words/block; bytes/word</dd>
<dt>dbbits_t</dt><dd>total bits in database</dd>
<dt>dboffset_t</dt><dd>offset into database (in bytes)</dd>
<dt>nqueries_t</dt><dd>number of simultanous queries</dd>
<dt>nservers_t</dt><dd>number of servers; privacy threshold; tau-independence</dt>
</dl>
*/
